package android.com.cleaner.apiResponses.completedJobs;
...
public class Payload {
    ...
    public Integer getNoOfJobsCompleted() {
        return noOfJobsCompleted;
    }

    public void setNoOfJobsCompleted(Integer noOfJobsCompleted) {
        this.noOfJobsCompleted = noOfJobsCompleted;
    }

    @SerializedName("NoOfJobsCompleted")
    @Expose
    private Integer noOfJobsCompleted;
